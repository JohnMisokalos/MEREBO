...
const requestQuerySolr = async function (searchItem, prodNumber, rowsNumber) {
  console.log("From SolrConnector searchTerm: " + searchItem);
  console.log("From SolrConnector prodNumber: " + prodNumber);
  console.log("From SolrConnector rows: " + rowsNumber);
  let query = client
    .query()
    .q(`ProdName${prodNumber}:"${searchItem}"`)
    .addParams({
      wt: "json",
      indent: true,
    })
